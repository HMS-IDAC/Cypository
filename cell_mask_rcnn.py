mode = 'deploy_with_PI2D' # 'train', 'test', 'deploy', 'deploy_with_PI2D'
num_epochs = 3 # number of train epochs
model_path = 'cell-mask-rcnn-model.pt'
dataset_path = '/home/cicconet/Downloads/Adrian/Annotations_All'
train_subset_fraction = 0.9 # fraction of dataset used to train; remaining goes to 'test' subset
deploy_path_in = '/home/cicconet/Downloads/Adrian/Deploy_Inputs'
deploy_path_out = '/home/cicconet/Downloads/Adrian/Deploy_Outputs'
...
from toolbox import listfiles, tifread, uint16Gray_to_uint8RGB, imread, Compose, RandomHorizontalFlip, ToTensor, \
    ...
    uint16Gray_to_doubleGray, doubleGray_to_uint8RGB
